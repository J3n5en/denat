...
import {
  ...
  parse,
  posix,
} from "https://deno.land/x/serve@1.0.4/deps.ts";

// types
import type {
  Args,
  EntryInfo,
} from "https://deno.land/x/serve@1.0.4/src/utils/types.ts";
import type {
  Response,
  ServerRequest,
} from "https://deno.land/x/serve@1.0.4/deps.ts";
...
// pages
import errPage from "https://deno.land/x/serve@1.0.4/src/pages/err.ts";
import dirPage from "https://deno.land/x/serve@1.0.4/src/pages/dir.ts";
...
export default function serve(target: string, port: number) {
    ...
    async (req): Promise<void> => {
      ...
      try {
        ...
        if (fileInfo.isDirectory) {
          response = await serveDir(req, target, fsPath);
        } else {
